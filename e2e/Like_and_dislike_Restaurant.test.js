...
Scenario('like and unlike a restaurant in one flow', async ({ I }) => {
  // Buka halaman utama dan pilih restoran pertama
  I.amOnPage('/#/');
  ...
  // Verifikasi bahwa tombol berubah menjadi unlike
  ...
  // Unlike restoran tanpa refresh
  I.click('#likeButton');

  // Verifikasi bahwa tombol kembali menjadi like
