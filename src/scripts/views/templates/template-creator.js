...
const createRestaurantItemTemplate = (restaurant) => `
        <article tabindex="0" class="card">
            ...
            <div class="card-content">
                <p class="card-content-title"><a href="${`/#/detail/${restaurant.id}`}">${
  restaurant.name
} - ${restaurant.city}</a></p>
...
<picture>
<source class="detail-img lazyload" srcset="${
  CONFIG.BASE_IMAGE_SMALL_URL + restaurant.pictureId
}" type="image/webp" media="all and (max-width: 300px)" />        
<source class="detail-img lazyload" srcset="${
  CONFIG.BASE_IMAGE_SMALL_URL + restaurant.pictureId
}" type="image/jpeg" media="all and (max-width: 300px)" />
<source class="detail-img lazyload" srcset="${
  CONFIG.BASE_IMAGE_MEDIUM_URL + restaurant.pictureId
}" type="image/webp" media="all and (min-width: 700px) and (max-width: 900px)" />    
<source class="detail-img lazyload" srcset="${
  CONFIG.BASE_IMAGE_MEDIUM_URL + restaurant.pictureId
}" type="image/jpeg" media="all and (min-width: 700px) and (max-width: 900px)" />
<source class="detail-img lazyload" srcset="${
  CONFIG.BASE_IMAGE_LARGE_URL + restaurant.pictureId
}" type="image/webp" media="all and (min-width: 901px)" />        
<source class="detail-img lazyload" srcset="${
  CONFIG.BASE_IMAGE_LARGE_URL + restaurant.pictureId
}" type="image/jpeg" media="all and (min-width: 901px)" />
